                  ...
                  leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                        <div className='inline-block align-bottom bg-white rounded-lg px-4 pt-5 
                         ...
                         sm:align-middle sm:max-w-sm sm:w-full sm:p-6'>
                              <div>
                                    {selectedFile ? <img src={selectedFile} onClick={() => setSelectedFile(null)} 
                                    alt="uploaded image" 
                              ...
                              className='mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 cursor-pointer'>
                                    ...
                                    <div className='mt-5 sm:mt-6'>
                                          ...
                                          focus:ring-offset-2 focus:ring-red-500 py-2 bg-red-600 
                                           text-base font-medium text-white hover:bg-red-700 
                                           focus:outline-none sm:text-sm disabled:bg-gray-500 disabled:cursor-not-allowed 
                                           hover:disabled:bg-gray-300 focus:ring-2' onClick={uploadPost}>
